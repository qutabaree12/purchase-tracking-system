...
export default function Sidebar() {
  ...
  return (
    <>
      {/* Dark overlay behind the sidebar on small screens, so clicking
          outside it closes it. Only rendered when sidebar is open
          AND we're on a small screen (handled via md:hidden). */}
      {sidebarOpen && (
        <div
