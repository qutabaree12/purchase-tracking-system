...
export default function TopBar() {
  ...
  return (
    <header className="bg-white border-b border-brand-line px-6 py-4 flex items-center justify-between gap-4"
      ...
      <div className="flex items-center gap-4 min-w-0">
        ...
        <div className="min-w-0">
          <h1 className="text-[18px] font-medium text-brand-navy leading-snug">{pageTitle}</h1>
