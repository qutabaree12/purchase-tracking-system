...
const defaultTitles = [
  ...
  {
    match: '/purchases/regroupement',
    title: 'Regroupement des demandes',
  },
  {
    match: '/purchases/request/new',
    title: "Nouvelle demande d'achat",
  },
  {
    match: '/purchases/requests',
    title: "Demandes d'achat",
  },
  {
    match: '/purchases/order/new',
...
function defaultTitleFor(pathname) {
  const hit = defaultTitles.find((item) =>
    pathname.startsWith(item.match)
  )

  return hit ? hit.title : 'Tableau de bord'
}
...
export default function TopBar() {
  ...
  const pageTitle =
    title || defaultTitleFor(location.pathname)

  return (
    <header
      className="bg-white border-b border-brand-line px-6 py-4 flex items-center justify-between gap-4"
      style={{ padding: '14px 24px' }}
    >
      ...
      <div className="flex items-center gap-4 min-w-0">
        ...
        <div className="min-w-0">
          ...
          <h1 className="text-[20px] font-semibold text-brand-navy leading-snug">
            {pageTitle}
          </h1>
      ...
      <div className="flex items-center gap-3 shrink-0">
        ...
        <div className="relative">
          ...
          <span
            className="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-brand-badge"
          />
